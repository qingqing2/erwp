				        ...
				        <div class="article">
					          ...
					          <div>
					               ...
					               <c:choose>
					               		...
					               		<c:otherwise>
					               			<a href="<%=path %>/goodsAll.action">首页</a>
							            	&nbsp;&nbsp;&nbsp;
							            	<a href="<%=path %>/goodsAll.action?index=${page.index - 1 }"/>上一页</a>
					               		</c:otherwise>
					               </c:choose>
					               
					               <c:choose>
					               		<c:when test="${page.index != page.totlePage}">
					               			<a href="<%=path %>/goodsAll.action?index=${page.index + 1 }"/>下一页</a>
							            	&nbsp;&nbsp;&nbsp;
							            	<a href="<%=path %>/goodsAll.action?index=${page.totlePage }"/>尾页</a>
					               		</c:when>
					               		<c:otherwise>
					               			下一页&nbsp;&nbsp;&nbsp;尾页
					               		</c:otherwise>
